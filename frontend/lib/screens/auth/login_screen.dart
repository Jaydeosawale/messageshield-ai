...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _continueWithGoogle() async {
    ...
    try {
      ...
      final firebase_auth.User firebaseUser = await GoogleAuthService.signIn();
      ...
      await context.read<AuthProvider>().loginWithFirebaseUser(
            firebaseUser,
          );
      ...
      //
      // Do not leave Firebase/Google authenticated
      // when there is no valid MessageShield session.
